"""Service limits as defined in OGx-1.txt sections 2.3, 3.4.

This module defines service limits and thresholds for the OGx API.

Message Retention and Limitations (from OGx-1.txt section 2.3):
...
OGx API Usage Examples:

    # Example 1: Check message retention
    # GET https://OGx.orbcomm.com/api/v1.0/get/re_messages
    from_utc = (
    ...
    # POST https://OGx.orbcomm.com/api/v1.0/submit/messages
...
MAX_ISATDATA_PRO_SMALL_PAYLOAD_BYTES: Final[int] = 400
"""IsatData Pro small message payload limit in bytes."""

MAX_ISATDATA_PRO_MEDIUM_PAYLOAD_BYTES: Final[int] = 2000
"""IsatData Pro medium message payload limit in bytes."""

MAX_ISATDATA_PRO_LARGE_PAYLOAD_BYTES: Final[int] = 10000
"""IsatData Pro large message payload limit in bytes."""
