"""Message states as defined in OGx-1.txt Section 4.3 Tables 1 & 2."""

from enum import IntEnum


class MessageState(IntEnum):
    """Message states from OGx-1.txt Section 4.3 Tables 1 & 2."""

    ACCEPTED = 0  # Message accepted by OGx/IGWS
