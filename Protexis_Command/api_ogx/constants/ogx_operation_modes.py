...
Usage Examples:
    ...
    from Protexis_Command.api_ogx.constants import OperationMode, NetworkType
...
class OperationMode(IntEnum):
    """Operation modes as defined in OGx-1.txt.
