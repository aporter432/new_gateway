"""Message format constants as defined in OGx-1.txt.

This module defines the required fields and properties for OGx messages.

Common Message Format (from OGx-1.txt):
- Required Fields:
...
# Required fields for every message per OGx-1.txt
...
# Required properties for every field per OGx-1.txt
...
# Required properties for non-array fields per OGx-1.txt
...
# Implementation Note: While OGx-1.txt defines elements as indexed structures
