"""Authentication and authorization constants as defined in OGx-1.txt.
...
Usage Examples:
    ...
    from Protexis_Command.api_ogx.constants import GrantType
    import httpx
    ...
    from Protexis_Command.api_ogx.constants import AuthRole, APIEndpoint
...
class AuthRole(str, Enum):
    """Authorization roles as defined in OGx-1.txt section 3.2.
...
class GrantType(str, Enum):
    """Authentication grant types as defined in OGx-1.txt section 4.1.1.
...
class ThrottleGroup(str, Enum):
    """Message throttling groups as defined in OGx-1.txt section 4.4.
