"""Message size validation according to OGx-1.txt.
...
from .....api_ogx.constants.ogx_limits import MAX_OGX_PAYLOAD_BYTES
...
from ..common.ogx_validation_exceptions import SizeValidationError, ValidationError
