...
def decode_state(data: str) -> Dict[str, Any]:
    ...
    Implements state decoding as defined in OGx-1.txt Section 5.1.
...
def decode_metadata(data: str) -> Dict[str, Any]:
    ...
    Implements metadata decoding as defined in OGx-1.txt Section 5.1.
...
def decode_message(data: Union[str, Dict[str, Any]]) -> OGxMessage:
    ...
    Implements message decoding as defined in OGx-1.txt Section 5.1.
