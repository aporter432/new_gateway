"""OGx transport optimization service.

This module implements transport selection logic following OGx-1.txt specifications:
...
from Protexis_Command.api_ogx.constants.ogx_network_types import NetworkType
...
class TransportOptimizer:
    ...
    async def determine_transport(
        ...
        Implements transport selection following OGx-1.txt Section 5.4:
        ...
        if not transport_metrics:
            raise ValidationError(
                "No healthy transports available", error_code=ValidationError.INVALID_MESSAGE_FORMAT
            )
    ...
    def _get_available_transports(self) -> List[TransportType]:
        ...
        return [TransportType.SATELLITE, TransportType.CELLULAR]
