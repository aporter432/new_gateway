"""OGx session management service.

This module implements session handling as defined in OGx-1.txt Section 3.
It handles:
...
from Protexis_Command.protocol.ogx.constants.ogx_error_codes import HTTPErrorCode
...
class SessionHandler:
    """Handles OGx session management.

    This class implements session management according to OGx-1.txt Section 3.
    It handles:
    ...
    def __init__(self) -> None:
        ...
        self.session_key_prefix = "OGx:session:"
    ...
    async def create_session(self, credentials: Dict[str, str]) -> str:
        """Create new session with OGx.

        Args:
            credentials: Authentication credentials
                Required:
                    - client_id: OGx client ID
                    - client_secret: OGx client secret
                Optional:
