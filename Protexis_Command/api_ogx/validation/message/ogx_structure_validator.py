...
from ...constants.ogx_message_format import REQUIRED_MESSAGE_FIELDS
from ...protocol.ogx_base_validator import OGxBaseValidator
from ..ogx_validation_exceptions import ValidationError
from .ogx_type_validator import ValidationContext, ValidationResult


class OGxStructureValidator(OGxBaseValidator):
    """Validates OGx messages according to OGx-1.txt Section 5."""
    ...
    def validate(self, data: Dict[str, Any], context: ValidationContext) -> ValidationResult:
        """Validate message structure and content per OGx-1.txt Section 5.
