    ...
    def validate(self, field: Dict[str, Any], context: ValidationContext) -> ValidationResult:
        ...
        try:
            ...
            try:
                ...
                raise ValidationError(f"Invalid field type: {field_type_str}")
            ...
            if field_type in (FieldType.DYNAMIC, FieldType.PROPERTY):
                ...
                # Use inherited field type validation
            ...
            if field.get("Elements"):
                if field_type != FieldType.ARRAY:
                    raise ValidationError("Elements only valid for Array type fields")
                for element in field["Elements"]:
                    self.element_validator.validate(element, context)
